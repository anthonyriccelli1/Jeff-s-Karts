        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-slate-50 rounded-3xl p-8 border border-slate-200 shadow-sm">
            ...
            >
              ...
              <button
                type="submit"
                className="w-full px-8 py-4 bg-teal-600 hover:bg-teal-500 text-white font-semibold rounded-xl transition-all shadow-lg shadow-teal-500/25 hover:shadow-teal-500/40 hover:scale-[1.02]"
              >
                Send Message
              </button>
